...
void printHeader()
{
    ...
    std::cerr << "Ctyper " + string(vctyper) + "\nPangenome allele database version: " + vdatabase + "\n"
        ...
        << "Databases (genotyping matrices and pangenome allele annotations): https://zenodo.org/records/16340156\n\n";
}
